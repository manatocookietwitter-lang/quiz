...
const APP_SHELL = [
  BASE_URL.href,
  INDEX_URL,
  new URL('manifest.webmanifest?v=20260804-3', BASE_URL).href,
  new URL('icons/icon-192.png?v=20260804-3', BASE_URL).href,
  new URL('icons/icon-512.png?v=20260804-3', BASE_URL).href,
  new URL('icons/maskable-512.png?v=20260804-3', BASE_URL).href,
];
